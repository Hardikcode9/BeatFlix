...
const queries = [
  'Hera Pheri 2000 full movie',
  'Welcome 2007 full movie',
  'Dhamaal full movie',
  ...
  'Kabhi Khushi Kabhie Gham full movie'
];
...
async function main() {
  ...
  fs.writeFileSync('movies_result2.json', JSON.stringify(results, null, 2));
}
