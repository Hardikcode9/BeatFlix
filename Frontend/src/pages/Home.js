    ...
    const fetchAll = async () => {
      try {
        const [r1, r2, r3, r4, r5] = await Promise.all([
          fetch("http://localhost:4000/api/movies/top-india").then(res => res.json()),
          fetch("http://localhost:4000/api/movies/top-global").then(res => res.json()),
          fetch("http://localhost:4000/api/movies/trending").then(res => res.json()),
          fetch("http://localhost:4000/api/movies/top-rated").then(res => res.json()),
          fetch("http://localhost:4000/api/movies/new-releases").then(res => res.json())
        ]);
